...
public static class DocGenerator
{
    ...
    public static Dictionary<string, BusinessDocument[]> BuildWorkloads(int seed = 1000)
    {
        var result = new Dictionary<string, BusinessDocument[]>();

        // Small
        {
            var items = new List<BusinessDocument>();
            for (int i = 0; i < 16; i++)
            {
                var doc = DocGenerator.MakeBusinessDocument(new DocGenerator.GenOptions
                {
                    Lines = 5,
                    Payments = 3,
                    Attachments = 0,
            ...
            result.Add("Small", items.ToArray());
        }
        ...
        // Medium
        {
            ...
            result.Add("Medium", items.ToArray());
        }
        ...
        // Large
        {
            ...
            result.Add("Large", items.ToArray());
        }
